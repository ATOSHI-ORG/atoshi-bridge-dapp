...
export const translations = {
  en: {
    ...
    'wallet.no_provider': 'No wallet detected in this browser yet.',
    'wallet.no_provider_help': 'In a private or incognito window, extensions are off unless you allow them in the extension settings. Otherwise install a wallet, or open this page inside the Atoshi wallet.',
  ...
  zh: {
    ...
    'wallet.no_provider': '当前浏览器暂未检测到钱包。',
    'wallet.no_provider_help': '无痕/隐私窗口下，浏览器扩展默认是禁用的，需要在扩展设置里允许它在无痕模式下运行。否则请安装钱包，或在 Atoshi 钱包内打开本页面。',
