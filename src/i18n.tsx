...
export const translations = {
  en: {
    ...
    'quota.multiple_tag': 'Must be a multiple of 100',
    ...
    'rules_modal.rule_mult_title': 'Exact multiples only',
    'rules_modal.rule_mult_desc': 'An amount that is not a multiple of the peg is refused rather than rounded. Rounding would lock the full amount here while asking Ethereum for less, quietly confiscating the difference.',
    ...
    'quota.usage_unavailable': 'These are the daily ceilings and do not subtract what has been used today -- the chain does not expose a usage query yet. The amount you can actually send may be lower; the chain decides at submission.',
  ...
  zh: {
    ...
    'quota.multiple_tag': '必须是 100 的整数倍',
    ...
    'rules_modal.rule_mult_title': '必须是整数倍',
    'rules_modal.rule_mult_desc': '不是锚定倍数的数量会被拒绝，而不是四舍五入。四舍五入意味着这边锁全额、那边只要一部分，差额被静默没收。',
    ...
    'quota.usage_unavailable': '下面显示的是每日上限，不含今日已用量 —— 链上暂未提供已用量查询。实际可转金额可能低于此处显示，以提交时链上的判定为准。',
    'tx.est_range': '1–5 分钟',
